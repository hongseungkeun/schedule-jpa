        ...
        mockMvc.perform(get("/api/schedules")
                ...
                .andDo(document("schedule-read-all",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("pageable.sort.unsorted").description("정렬되지 않은 여부"),
                                fieldWithPath("pageable.offset").description("현재 오프셋"),
                                fieldWithPath("pageable.paged").description("페이징 여부"),
                                fieldWithPath("pageable.unpaged").description("페이징되지 않은 여부"),
